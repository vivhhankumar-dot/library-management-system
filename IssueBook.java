...
public void clear(){
    ...
    private void btnissueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissueActionPerformed
        ...
        txtstudentid.getText().equals("") ||
        txtbookname.getText().equals("") ||
        txtduedate.getText().equals("")) {

        JOptionPane.showMessageDialog(this, "Fill all details properly");
        return;
    }

    try {
        pst = c.prepareStatement(
            "INSERT INTO issue_books (book_id, book_name, student_id, issue_date, due_date) VALUES (?,?,?,?,?)"
        );

        pst.setInt(1, Integer.parseInt(txtid.getText()));
        pst.setString(2, txtbookname.getText());
        pst.setInt(3, Integer.parseInt(txtstudentid.getText()));
        pst.setString(4, txtissuedate.getText());
