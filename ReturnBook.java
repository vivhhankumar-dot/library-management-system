...
public class ReturnBook extends javax.swing.JFrame {
    ...
    try {
        // issue_books + students join
        pst = c.prepareStatement(
            "SELECT i.book_id, i.book_name, i.issue_date, i.due_date, s.student_name " +
            "FROM issue_books i " +
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if (txtbookid.getText().equals("") || txtstudentid.getText().equals("")) {
        JOptionPane.showMessageDialog(this, "Search book before returning");
        return;
    }

    try {
        pst = c.prepareStatement(
            "DELETE FROM issue_books WHERE book_id = ? AND student_id = ?"
        );
